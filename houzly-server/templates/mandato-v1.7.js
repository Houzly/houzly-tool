/**
 * Template contratto di mandato Houzly — versione 1.7
 *
 * REGOLA: questo file non si modifica mai dopo che una pratica lo ha usato.
 * Per cambiare il testo si crea mandato-v1.8.js e si aggiorna templates/index.js.
...
module.exports = {
  versione: '1.7',
  dataVersione: 'Settembre 2026 (rev. 3)',
      ...
      commi: [
        {
          ...
          testo:
            ...
            'presente contratto, **copia di un documento d\u2019identit\u00e0 in corso di validit\u00e0 del ' +
            'sottoscrittore e la visura catastale dell\u2019Immobile**, quest\u2019ultima necessaria alla ' +
            'verifica della titolarit\u00e0 e dei dati identificativi dichiarati.',
        },
        {
          n: '5.1-bis',
          testo:
